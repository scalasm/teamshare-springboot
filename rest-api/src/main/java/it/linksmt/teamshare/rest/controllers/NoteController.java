...
public class NoteController {
	...
	/**
	 * @RequestParam(name = "numero_pagina", required = false, defaultValue =
	 *                    "0")
	 * @ApiParam(value = "Numero di pagina", required = false, defaultValue =
	 *                 "0") final int numeroPagina,
	 * @RequestParam(name = "numero_elementi_per_pagina", required = false,
	 *                    defaultValue = "0")
	 * @ApiParam(value = "Numero di elementi per pagina", required = false,
	 *                 defaultValue = "0") final int numeroElementiPerPagina
	 * @return
	 */
